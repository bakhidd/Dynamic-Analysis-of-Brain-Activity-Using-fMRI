...
his repository contains an implementation of a full pipeline for analysis and prediction of brain activity from fMRI data using nonlinear manifold learning and dynamical systems methods.
...
Stimuli are loaded from a MATLAB file (conditions.mat).